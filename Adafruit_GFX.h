...
void Adafruit_GFX_DrawCharAdv( Adafruit_GFX_Driver_t *driver,  int16_t x, int16_t y, unsigned char c, uint16_t color,   uint16_t bg, uint8_t size_x, uint8_t size_y );
void Adafruit_GFX_DrawChar( Adafruit_GFX_Driver_t *driver,  int16_t x, int16_t y, unsigned char c, uint16_t color,   uint16_t bg, uint8_t size );
